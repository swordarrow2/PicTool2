...
public class ResultAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Bitmap bitmap = MainActivity.instance.getFragment(SauceNaoMain.class).hashMap.get(result.mThumbnail);
        if (bitmap == null) {
            MainActivity.instance.getFragment(SauceNaoMain.class).threadPool.execute(new DownloadThumbnailRunnable(activity, holder.thumbnail, result.mThumbnail));
        } else {
