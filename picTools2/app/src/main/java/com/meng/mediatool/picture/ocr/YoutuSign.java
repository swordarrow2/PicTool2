package com.meng.mediatool.picture.ocr;
...
public class YoutuSign {
     ...
     * @return 0表示成功
     */
    public static int appSign(String appId, String secret_id, String secret_key, long expired, String user_id, StringBuffer mySign) {
