...
public class BarcodeAwesomeArbGif extends Fragment {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.gif_arb_qr_button_selectImg:
                    ...
                    MainActivity.instance.selectImage(BarcodeAwesomeArbGif.this);
                    break;
        ...
        new Thread(new Runnable() {
				...
				public void run() {
					try {
						...
						MainActivity.instance.showToast("完成 : " + filePath);
					} catch (Exception e) {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == MainActivity.instance.SELECT_FILE_REQUEST_CODE && resultCode == Activity.RESULT_OK && data.getData() != null) {
            try {
                if (coding) {
                    MainActivity.instance.showToast("正在执行操作");
                } else {
