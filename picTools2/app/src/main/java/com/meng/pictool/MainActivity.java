...
import com.meng.pictool.menu.*;
import com.meng.pictool.task.*;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void showToast(final String msgAbbr, final String msgOrigin) {
        runOnUiThread(new Runnable() {
            ...
            @Override
            public void run() {
                Snackbar.make(mainLinearLayout, msgAbbr, Snackbar.LENGTH_LONG)
                        .setAction("查看全文", msgOrigin.trim().isEmpty() ? null : new View.OnClickListener() {
    ...
    public void showToast(final String msg) {
        runOnUiThread(new Runnable() {
            ...
            @Override
            public void run() {
                Snackbar.make(mainLinearLayout, msg, Snackbar.LENGTH_LONG)
