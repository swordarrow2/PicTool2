package com.meng.pictool.picture.barcode;
...
public class BarcodeAwesome extends BaseFragment implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.awesomeqr_main_backgroundImage) {
            selectImage();
        } else if (id == R.id.awesomeqr_main_removeBackgroundImage) {
        ...
        } else if (id == R.id.awesomeqr_main_generate) {
        ...
        } else if (id == R.id.awesomeqr_mainButton_save) {
            try {
